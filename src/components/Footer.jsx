        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center space-x-4 mb-6">
              ...
              <div>
                <h3 className="text-2xl font-bold text-gray-400">Trading</h3>
                <p className="text-gray-400">Community Hub</p>
              </div>
            </div>
            <p className="text-gray-300 mb-6 max-w-md">
              Join the ultimate Discord trading community where gamers become traders and strategies become profits.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="/" className="text-gray-300 hover:text-white transition-colors duration-200">Dashboard</a></li>
              <li><a href="/auth" className="text-gray-300 hover:text-white transition-colors duration-200">Get Started</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Trading Guide</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Feedback</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Trading Blog</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">API Documentation</a></li>
              <li><a href="#" className="text-gray-300 hover:text-white transition-colors duration-200">Tutorials</a></li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2025 Trading Community. All rights reserved.
            </p>
            <div className="flex space-x-6 mt-4 md:mt-0">
              ...
              <a href="#" className="text-gray-400 hover:text-white text-sm transition-colors duration-200">Developer: Garssss</a>
            </div>
          </div>
        </div>
      </div>
